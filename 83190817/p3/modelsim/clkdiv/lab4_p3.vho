...
-- Design Ports Information
-- clk_out	=>  Location: PIN_U1,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \count~6_combout\ = (\Add0~0_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \count~5_combout\ = (\Add0~8_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \count~4_combout\ = (\Add0~12_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \count~3_combout\ = (\Add0~16_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \count~2_combout\ = (\Add0~18_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \count~1_combout\ = (!\Equal0~10_combout\ & \Add0~28_combout\)
...
-- Equation(s):
-- \count~0_combout\ = (\Add0~30_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \Equal0~5_combout\ = (count(15) & (!count(12) & (!count(13) & count(14))))
...
-- Equation(s):
-- \Equal0~7_combout\ = (count(9) & (count(8) & (\Equal0~5_combout\ & \Equal0~6_combout\)))
...
-- Equation(s):
-- \Equal0~8_combout\ = (!count(5) & (count(4) & (!count(7) & count(6))))
...
-- Equation(s):
-- \Equal0~9_combout\ = (!count(2) & (!count(1) & (!count(0) & !count(3))))
...
-- Equation(s):
-- \Equal0~2_combout\ = (!count(21) & (!count(22) & (!count(20) & !count(23))))
...
-- Equation(s):
-- \Equal0~3_combout\ = (!count(19) & (!count(16) & (!count(17) & !count(18))))
...
-- Equation(s):
-- \Equal0~1_combout\ = (!count(26) & (!count(25) & (!count(27) & !count(24))))
...
-- Equation(s):
-- \clockout~0_combout\ = \clockout~q\ $ (\Equal0~10_combout\)
